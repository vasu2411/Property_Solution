<%-- 
    Document   : successsaveproperty
    Created on : 14 Oct, 2016, 4:02:28 PM
    Author     : vasus
--%>
...
h3
{
    ...
    <ul>
        ...
        <font size="5">Your request has been successfully submitted.<b> Your property will appear in next 1 Hour.</b></font><br>
        <center>
