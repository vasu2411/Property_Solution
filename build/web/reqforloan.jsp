<%-- 
    Document   : reqforloan
    Created on : 19 Oct, 2016, 11:10:34 AM
    Author     : vasus
--%>
...
<ul>
  ...
  <li class="menu-item"><a class="active" href="reqforloan.jsp">Requests for loan</a></li>
  <li class="menu-item" style="float:right"><a href="index.html">Logout</a></li>
       ...
       <br><center><table border="1">
                        <tr>
                            ...
                            <td><center>Expected Loan amount</td>
                            <td><center>Salary (per month)</td>
                        </tr>    
    <% 
        int flag=0;
        int j=1;
    ...
    %>
                        <tr>
                            ...
                            <td><center><%out.println(expectam); %></td>
                            <td><center><%out.println(sal); %></td>
                        </tr>
                        <%
