...
public final class allproponrent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <li class=\"menu-item\"><a class=\"active\" href=\"allproponrent.jsp\">Properties for rent</a></li>\n");
      out.write("  <li class=\"menu-item\"><a href=\"reqforpnestimate.jsp\">Requests for PNestimate</a></li>\n");
      out.write("  <li class=\"menu-item\"><a href=\"reqforloan.jsp\">Requests for loan</a></li>\n");
      out.write("  <li class=\"menu-item\" style=\"float:right\"><a href=\"index.html\">Logout</a></li>\n");
      out.write("\n");
      out.write("</ul>\n");
      out.write("        <form action=\"deleteprop.jsp\">\n");
      out.write("       <br><table border=\"1\">\n");
      out.write("                                    <tr>\n");
      out.write("                                        <td><center>Srno.</td>\n");
      out.write("                                        <td><center>Name</td>\n");
      out.write("                                        <td><center>Contact</td>\n");
      out.write("                                        <td><center>I am</td>\n");
      out.write("                                        <td><center>Property for</td>\n");
      out.write("                                        <td><center>Type of property</td>\n");
      out.write("                                        <td><center>City</td>\n");
      out.write("                                        <td><center>Locality</td>\n");
      out.write("                                        <td><center>Society name</td>\n");
      out.write("                                        <td><center>bedrooms</td>\n");
      out.write("                                        <td><center>bathrooms</td>\n");
      out.write("                                        <td><center>balconies</td>\n");
      out.write("                                        <td><center>floor</td>\n");
      out.write("                                        <td><center>total floors</td>\n");
      out.write("                                        <td><center>Super built up area</td>\n");
      out.write("                                        <td><center>Built up area</td>\n");
      out.write("                                        <td><center>Carpet area</td>\n");
      out.write("                                        <td><center>Type of transaction</td>\n");
      out.write("                                        <td><center>Status</td>\n");
      out.write("                                        <td><center>Expected price</td>\n");
      out.write("                                        <td><center>Maintenance<br> /Month</td>\n");
      out.write("                                        <td><center>description</td>\n");
      out.write("                                    </tr>    \n");
      out.write("    ");
...
out.println(status); 
      out.write("</td>\n");
      out.write("                                <td><center>");
out.println(expectedpri); 
      out.write("</td>\n");
      out.write("                                <td><center>");
out.println(maintenancemonthly); 
      out.write("</td>\n");
      out.write("                                <td><center>");
out.println(description); 
      ...
      out.write("                            ");
                                ...
                                out.println("<td><input type='submit' name='delete' value='"+srno+"'>");
